...
#let name = "Christopher Gilbert"
#let locale-catalog-page-numbering-style = context { "Christopher Gilbert - Page " + str(here().page()) + " of " + str(counter(page).final().first()) + "" }
...
#let connections-list = (
  [#box(original-link("mailto:christopherfrommaine@gmail.com")[#fa-icon("envelope", size: 0.9em) #h(0.05cm)christopherfrommaine\@gmail.com])],
  [#box(original-link("tel:+1-207-409-6444")[#fa-icon("phone", size: 0.9em) #h(0.05cm)\(207\) 409-6444])],
  [#box(original-link("https://christopherfrommaine.netlify.app/")[#fa-icon("link", size: 0.9em) #h(0.05cm)christopherfrommaine.netlify.app])],
  [#box(original-link("https://linkedin.com/in/christopherfrommaine")[#fa-icon("linkedin", size: 0.9em) #h(0.05cm)christopherfrommaine])],
  [#box(original-link("https://github.com/christopherfrommaine")[#fa-icon("github", size: 0.9em) #h(0.05cm)christopherfrommaine])],
)
...
#emph[Undergrad in Computer Science and Physics]
  ],
  right-content: [
    #emph[Cambridge, MA]
  ],
...
#block(
  [
    #set par(spacing: 0pt)
    #two-col(left-column-width: design-highlights-summary-left-margin, right-column-width: 1fr, left-content: [], right-content: [#v(design-highlights-top-margin);#align(left, [Studying Quantum Information Science and Computational Physics])], column-gutter: 0cm)
  ],
  inset: (
    left: design-entries-left-and-right-margin,
    right: design-entries-left-and-right-margin,
...
#emph[Quantum Mechanics for Kids: 

a Humorous, Easy-to-Read, Math-Free Book on a Very Perplexing Subject]
  ],
  right-content: [
    #emph[2019]
  ],
